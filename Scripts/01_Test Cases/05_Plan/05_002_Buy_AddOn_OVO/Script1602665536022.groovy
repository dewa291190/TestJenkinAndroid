...
WebUI.callTestCase(findTestCase('Main_Function/05_Plan/02_Buy_AddOn'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Main_Function/05_Plan/03_Payment'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Main_Function/05_Plan/03_Payment_OVO'), [('OVO_Number') : '087788334061'], FailureHandling.STOP_ON_FAILURE)
