...
WebUI.callTestCase(findTestCase('Main_Function/04_Cashbac/01_ Change_MDN'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Main_Function/04_Cashbac/02_ Exhange_PointToCashbac'), [:], FailureHandling.STOP_ON_FAILURE)
