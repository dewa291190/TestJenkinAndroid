...
WebUI.callTestCase(findTestCase('Main_Function/02_Order_Sim/03_Register_Data_Verification'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Main_Function/02_Order_Sim/04_Payment'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Main_Function/02_Order_Sim/04_Payment_OVO'), [('OVO_Number') : '087788334061'], FailureHandling.STOP_ON_FAILURE)
