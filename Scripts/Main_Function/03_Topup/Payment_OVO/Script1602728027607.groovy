...
Mobile.verifyElementNotVisible(findTestObject('SIM/btnCheckPayment'), 10)

CustomKeywords.'com.mobile.keywords.ApplicationBehavior.checkTextContains'('Payment Pending')
