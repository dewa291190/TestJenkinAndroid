...
Mobile.tap(findTestObject('SIM/btnPay_PaymentShopee'), 10)

Mobile.tap(findTestObject('SIM/btnPay'), 10)

Mobile.delay(3, FailureHandling.STOP_ON_FAILURE)

Mobile.waitForElementPresent(findTestObject('SIM/btnInstall'), 10)
...
CustomKeywords.'com.mobile.keywords.ApplicationBehavior.checkTextContains'('ShopeePay')
