...
Mobile.setText(findTestObject('Cashbac/inputTop'), '98', 10)

Mobile.tap(findTestObject('Cashbac/btnExchange'), 10)

Mobile.delay(1)

CustomKeywords.'com.mobile.keywords.ApplicationBehavior.checkTextContains'('Minimum amount for exchange is 100 points')
